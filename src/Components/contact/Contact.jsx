      ...
      <div className="container contact__container">
        <div className="contact__options">
          <article className="contact__option">
            ...
            <a href="mailto:something@gmail.com" target='_blank'>Send a message</a>
          </article>
          <article className="contact__option">
            <AiOutlineMessage className='contact__option_icon'/>
            <h4>LinkedIn</h4>
          ...
          <article className="contact__option">
            ...
            <h4>Whatsapp</h4>
            <h5>+Phone number</h5>
            <a href="https://wa.me/+971000000000" target='_blank'>Send a message</a>
          </article>
        </div>
